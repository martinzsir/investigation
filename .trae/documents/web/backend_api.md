...
| 后端里程碑 | 依赖批次 | 可交付端点 | 实施状态 |
|---|---|---|---|
| M1 地基 | 批 1-3（W-001/002/003/004/005/006/007） | 认证、案件门户、任务中心、元数据/版本指针/队列 | ✅ 已实施（2026-09-07 验证全绿） |
...
| M3 研判主流程 | 批 5（W-010/012/014/019/020/025） | 线索列表/详情/处置、数据接入、规则工坊、LLM 守卫 | 未实施（含 ActionExecutor/AuditChain 的 state.sqlite 写路径接线） |
| M4 配置与人审 | 批 6（W-011/013/015/016/017/021/022） | 模型设计器、权限遮蔽、知识包、视图、实体裁决、异常通道、治理页 18-22 | 未实施 |
